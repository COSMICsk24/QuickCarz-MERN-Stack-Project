...
const Testimonial = () => {
    const testimonials = [
        ...
        { name: "JP Smith", 
          ...
          testimonial: "The best car rental experience I've ever had! The luxury car was in pristine condition and the service was top-notch. Will definitely use again.",
        },
        { name: "Olga Ivanova", 
          location: "Moscow, Russia",
          image: assets.testimonial_image_1,
          testimonial: "A seamless experience from booking to drop-off. The staff was friendly and knowledgeable, and the car exceeded my expectations. Thank you for making my trip unforgettable!",
        }
    ];
  return (
